              ...
              <div className="bg-slate-50 rounded-2xl p-4 text-left border border-slate-100 flex items-center justify-between">
                ...
                <div className="flex -space-x-2">
                  {selectedTickets.slice(0, 3).map(n => (
                    <div key={n} className="w-11 h-11 rounded-full bg-white border-2 border-slate-50 flex items-center justify-center text-[10px] font-bold text-slate-400 shadow-sm flex-shrink-0">
                ...
                <div className="bg-blue-50/50 rounded-2xl p-4 border border-blue-100/50 animate-in fade-in duration-700">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {createdPurchase.tickets.filter((t: any) => t.isGift).map((t: any) => (
                      <div key={t.number} className="bg-white px-3 py-1 rounded-xl border border-blue-50 text-[10px] font-bold text-blue-500 shadow-sm">
