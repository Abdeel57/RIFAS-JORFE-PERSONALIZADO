  ...
  return (
    <div className="space-y-8 md:space-y-16 py-2 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-4 md:grid-cols-12 gap-2 md:gap-5 px-1 md:px-0">
        ...
        <div className="col-span-4 md:col-span-8 group relative overflow-hidden rounded-[2rem] md:rounded-[3.5rem] shadow-2xl h-64 md:h-[550px] border-2 md:border-[6px] border-white bg-black will-change-transform">
          {raffle.videoUrl ? (
            <>
              <iframe 
                ref={videoRef}
        ...
        <div className="col-span-2 md:col-span-4 h-32 md:h-[550px] flex flex-col gap-2 md:gap-5">
          <div className="flex-1 group relative overflow-hidden rounded-[1.2rem] md:rounded-[2.5rem] shadow-md border md:border-4 border-white will-change-transform">
            <SafeImage 
          ...
          <div className="hidden md:block flex-1 group relative overflow-hidden rounded-[2.5rem] shadow-md border-4 border-white will-change-transform">
            <SafeImage 
        ...
        <div className="col-span-2 md:hidden group relative overflow-hidden rounded-[1.2rem] shadow-md h-32 border border-white">
           <SafeImage 
              src={raffle.galleryImages[2]} 
              alt="Detalle 3"
              className="w-full h-full object-cover"
